        ...
        <div class="bg-gray-800 rounded-lg shadow-xl overflow-hidden lg:grid lg:grid-cols-2 lg:gap-4">
            <div class="pt-10 pb-12 px-3 sm:pt-16 sm:px-8 lg:py-16 lg:pr-0 xl:py-20 xl:px-10">
                <div class="lg:self-center">
                    ...
                    <p class="mt-4 text-lg leading-6 text-sky-100">Если вы заинтересованы в продвижении вашей продукциив вашем регионе и гарантируете качество и конкурентную цену, то ознакомьтесь с нашим предложением.</p>
            ...
            <div class="-mt-6 aspect-w-5 aspect-h-3 md:aspect-w-2 md:aspect-h-1">
                <img class="transform translate-x-6 translate-y-6 rounded-md object-cover object-left-top sm:translate-x-16 lg:translate-y-20" src="https://storage.yandexcloud.net/brand-logo/mos-mebel/MarketingSectionV2/partner.jpeg" alt="App screenshot">
            </div>
        </div>
    </div>
</div>
